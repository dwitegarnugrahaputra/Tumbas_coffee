...
class InvoiceView extends GetView<InvoiceController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // Nggak pakai AppBar biar lebih clean sesuai desain
      body: SafeArea(
            ...
            children: [
              ...
              SizedBox(
                ...
                child: TextButton.icon(
                  ...
                  icon: const Icon(Icons.download, color: AppColors.darkAccent, size: 20),
                  label: const Text('Simpan Bukti Transaksi', style: TextStyle(color: AppColors.darkAccent, fontWeight: FontWeight.bold, fontSize: 14)),
                ),
              ),
              const SizedBox(height: 40),
            ],
...
// Custom Widget untuk garis putus-putus
